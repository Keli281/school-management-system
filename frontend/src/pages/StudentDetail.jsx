  ...
  const fetchStudentData = async (isRefresh = false) => {
    try {
      ...
      try {
        ...
        console.log('📊 Sample payment object:', paymentsData[0]);
    ...
    <div className="space-y-8 pb-8">
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-maroon">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="space-y-2 md:col-span-2 lg:col-span-4">
                ...
                <div className="flex items-center space-x-4">
                  <span className={`px-4 py-2 rounded-lg text-lg font-semibold ${
                    ...
                    {fee.paid ? '✅ PAID' : '⚠️ PENDING'}
                  </span>
                  {fee.paid && (
                    <div className="text-sm">
                      <p className="text-gray-600">Amount: <span className="font-semibold">KSh {fee.amount?.toLocaleString() || '0'}</span></p>
                      {fee.paymentDate && (
                        <p className="text-gray-600">Paid on: <span className="font-semibold">
                  ...
                  {!fee.paid && (
                    <p className="text-sm text-gray-500 italic">
                      Admission fee applicable for 2026+ students
                    </p>
                  )}
                </div>
              </div>
          ...
          {/* END ADMISSION FEE STATUS BLOCK */}
        </div>
      </div>
